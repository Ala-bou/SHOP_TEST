...
public class PremiumFragment extends Fragment {
    ...
    public static List<Brands> brandsList_premium = new ArrayList<>();
...
//                    if (ds.getKey().equals("-M44qVpLHDIBvVqNJxRF"))
                ...
                listDocumentAdapter = new ListDocumentAdapter(getActivity(), R.layout.brand_item, brandsList_premium);
                listDocumentAdapter.setListData(brandsList_premium);
